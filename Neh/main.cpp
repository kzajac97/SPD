...
int main(void)
{
    ...
    // std::chrono::duration<double,std::nano> diff3 = std::chrono::duration_cast<std::chrono::duration<double,std::nano>> (end3-start3);
    // std::chrono::duration<double,std::nano> diff4 = std::chrono::duration_cast<std::chrono::duration<double,std::nano>> (end4-start4);

    // std::cout << "neh time: " << diff3.count() << "\n";
    // std::cout << "acceleration time: " << diff4.count() << "\n";

...
Bin/spd.exe: Bin Bin/main.o Bin/annealing.o Bin/flowshop.o Bin/neh.o Bin/scharge.o Bin/utility.o 
	g++ -o Bin/spd.exe Bin/main.o Bin/flowshop.o Bin/neh.o Bin/annealing.o Bin/scharge.o Bin/utility.o
